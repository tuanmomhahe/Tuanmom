...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>tuấn mõm chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "tuấn mõm", HidePremium = false, IntroText = "tuấn mõm⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("tuấn mõm SCRIPT")
W:AddLabel("Discordtuấn mõm")
local Section = W:AddSection({
    Name = "Status"
})
